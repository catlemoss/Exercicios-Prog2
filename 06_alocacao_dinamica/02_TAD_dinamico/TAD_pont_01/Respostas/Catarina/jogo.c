...
tJogo* CriaJogo()
{
    ...
    j->jogador1 = CriaJogador(ID_JOGADOR_1);
    j->jogador2 = CriaJogador(ID_JOGADOR_2);
...
void ComecaJogo(tJogo* jogo)
{
    ...
    while (1)
    {
        ...
        venceuJogador1 = VenceuJogador(jogo->jogador1, jogo->tabuleiro);
        ImprimeTabuleiro(jogo->tabuleiro);
        if (venceuJogador1 || AcabouJogo(jogo)) break;

        JogaJogador(jogo->jogador2, jogo->tabuleiro);
        venceuJogador2 = VenceuJogador(jogo->jogador2, jogo->tabuleiro);
        ImprimeTabuleiro(jogo->tabuleiro);
