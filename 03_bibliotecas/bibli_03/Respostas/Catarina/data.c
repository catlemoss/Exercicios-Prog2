...
{
    if (!verificaDataValida(dia, mes, ano)) return 0;
...
int calculaDiasAteMes(int mes, int ano)             // num dias desde janeiro
{
    int dias = 0;
...
// essa função tranforma em dias e depois subtrai, desde o ano 0